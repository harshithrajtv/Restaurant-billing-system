...
void CouponCode:: addCouponCode() {
    ...
    do {
        ...
        cin>>coupon_code;
        if((coupon_code[0]>='0'&&coupon_code[0]<='9')&&(coupon_code[1]>='0'&&coupon_code[1]<='9') ) {
            x=false;
        } else if((coupon_code[coupon_code.length()-1 ]>='0'&&coupon_code[coupon_code.length()-1 ]<='9')&&(coupon_code[coupon_code.length()-2 ]>='0'&&coupon_code[coupon_code.length()-2 ]<='9') ) {
            x=false;
        } else {
            cout<<endl<<"Try again...(See condition in NOTE)"<<endl;
        }
    } while(x);
    FileHandling f;
...
void foodjoint:: welcome() {
    cout<<"\t\t\t\t========================================\n";
    cout<<"\t\t\t\t|Welcome to blah blah fast food service|\n";
    cout<<"\t\t\t\t========================================\n";
...
main_menu:
    ...
    if(discountPercentage<0) {
        ...
        cout<<endl<<setw(45)<<"Coupon('"<<setw(EnteredCouponCode.length())<<EnteredCouponCode<<setw(15)<<"') Discount:-  -"<<setw(5)<<(bill*discountPercentage/100.0)<<endl;
        cout<<"-------------------------------------------------------------------------------"<<endl;
